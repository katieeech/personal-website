        ...
        <div className="work-detail-outer">
            ...
            <div className="work-detail-container">
                <div className="work-detail-left-div">
                    <h1>HummingEffect</h1>
                    <h4>2021 • <a href="http:" target="_blank" rel="noopener noreferrer">Demo</a> • <a href="https://github.com/katiehyewonchoi/HummingEffect-frontend" target="_blank" rel="noopener noreferrer">Frontend</a>
                        • <a href="https://github.com/katiehyewonchoi/HummingEffect-backend" target="_blank" rel="noopener noreferrer">Backend</a></h4>
                ...
                <div className="work-detail-right-div">
                    ...
                    <p> HummingEffect is a humming game that can be played with at least two players who like music.
                        ...
                        The game is loaded with about 6000 songs.
